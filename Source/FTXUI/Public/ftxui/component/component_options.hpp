...
struct FTXUI_API UnderlineOption {
  bool enabled = false;
...
/// @ingroup component
struct FTXUI_API AnimatedColorOption {
  void Set(
      Color inactive,
      Color active,
...
struct FTXUI_API AnimatedColorsOption {
...
/// @ingroup component
struct FTXUI_API MenuEntryOption {
...
/// @ingroup component
struct FTXUI_API CheckboxOption {
  // Standard constructors:
...
/// @ingroup component
struct FTXUI_API RadioboxOption {
  // Standard constructors:
...
struct FTXUI_API ResizableSplitOption {
  Component main;
  Component back;
...
struct FTXUI_API WindowRenderState {
...
// @ingroup component
struct FTXUI_API WindowOptions {
